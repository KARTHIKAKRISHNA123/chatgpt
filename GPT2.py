...
class FeedForwardNetwork(Layer):
    def __init__(self, embed_dim, dff):
        super().__init__()
        self.dense1 = Dense(dff, activation='gelu')  # GELU activation
...
class GPT2(Model):
    ...
    def create_casual_mask(self, seq_len):
        ...
        return 1 - mask  # Convert to upper-triangular mask
    ...
    def call(self, x):
        ...
        for transformer_block in self.transformer_blocks:
            x = transformer_block(x, casual_mask)
